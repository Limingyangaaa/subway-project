    ...
    2: [function (require, module, exports) {
        ...
        module.exports = {
            enable: function (instance) {
                ...
                zoomGroup.setAttribute('transform', 'translate(' + ( instance.width - 100 ) + ' ' + ( instance.height - 150 ) + ') scale(0.75)');
            ...
            , _createZoomIn: function (instance) {
                ...
                zoomIn.setAttribute('transform', 'translate(38 0) scale(0.02)');
                ...
                zoomInBackground.setAttribute('rx', '260');
                zoomInBackground.setAttribute('ry', '260');
            ...
            , _createZoomReset: function (instance) {
                ...
                resetPanZoomControl.setAttribute('transform', 'translate(5 35) scale(0.55)');
                ...
                resetPanZoomControlBackground.setAttribute('rx', '10');
                resetPanZoomControlBackground.setAttribute('ry', '10');
            ...
            , _createZoomOut: function (instance) {
                ...
                zoomOut.setAttribute('transform', 'translate(38 75) scale(0.02)');
                ...
                zoomOutBackground.setAttribute('rx', '260');
                zoomOutBackground.setAttribute('ry', '260');
        ...
        module.exports = {
            ...
            , getOrCreateViewport: function (svg, selector) {
                ...
                if (!viewport) {
                    ...
                    viewport.setAttribute('class', 'main-viewport');
